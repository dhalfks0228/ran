...
INSERT INTO `course` VALUES ('202021ipc001','컴퓨터개론','유관순',2,2,'화1A,1B,2A,2B'),('202021ipc002','기초전기','이순신',3,4,'월1A,1B,2A목1A,1B,2A'),('202021msc001','대학수학기초','홍길동',3,3,'월1A,1B,2A수1A,1B,2A'),('202022msc001','대학수학기초','임꺽정',3,3,'화1A,1B,2A목1A,1B,2A');
