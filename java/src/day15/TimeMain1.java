...
public class TimeMain1 {
	...
	public static void main(String[] args) {
		 ...
		 * 매개변수, 지역변수 : 갈색
		 * 멤버변수 : 파란색 , static : 기울림, final : 굵게 
		 * YEAR은 java에서 기본 제공하는 final static 멤버변수라 클래스.Year
		 * 월의 경우 0 ~ 11을 반환
...
//		System.out.println("시 : " + today.get(Calendar.MINUTE));
//		System.out.println("시 : " + today.get(Calendar.SECOND));
//		System.out.println("오전(0), 오후(1) : " + today.get(Calendar.AM_PM));
		...
		System.out.println(year+"-"+month+"-"+day+"("+dayOfWeekString+")");
