...
public class ListEx1 {
	...
	public static void main(String[] args) {
		 ...
		 * 예를들어 오늘의 할일을 ArrayList에 저장하려고 한다.
		 * 이 때 클래스명A에 적당한 클래스는?
		 * 하루 일과를 문자열로 저장 => String
		 * */
...
//		});
		...
		System.out.println("--------");
		Iterator<String> it = list.iterator(); // 컬랙션에서 자주 사용하는 출력 코드.
		while(it.hasNext()) { // 값이 있다면 true,없다면 false 
			String tmp = it.next(); // 다음 정보를 가져옴. 
